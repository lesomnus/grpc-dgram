...
- **[Envelope batching: the measurement](./batching-measurement.md)** — the
  benchmark behind TODO §1's decision that the batching policy belongs to the
  application, and what it found: the transport is 87% of what a message costs
  to send, and that is 0.1% of a core at the rate this library is for.
