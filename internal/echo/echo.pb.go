...
type EchoRequest struct {
	...
	xxx_hidden_CircularShift int32                  `protobuf:"varint,4,opt,name=circular_shift,json=circularShift"`
	xxx_hidden_Repeat        uint32                 `protobuf:"varint,5,opt,name=repeat"`
	xxx_hidden_OverVoid      bool                   `protobuf:"varint,6,opt,name=over_void,json=overVoid"`
...
type EchoResponse struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Message     string                 `protobuf:"bytes,2,opt,name=message"`
	xxx_hidden_Sequence    uint32                 `protobuf:"varint,3,opt,name=sequence"`
	xxx_hidden_DateCreated *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=date_created,json=dateCreated"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type EchoBatchResponse struct {
	state            protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Items *[]*EchoResponse       `protobuf:"bytes,1,rep,name=items"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_echo_echo_proto_rawDesc = "" +
	"\n" +
	"\x0fecho/echo.proto\x12\x04echo\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe8\x01\n" +
	"\vEchoRequest\x12$\n" +
	"\x06status\x18\x01 \x01(\v2\f.echo.StatusR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x0ecircular_shift\x18\x04 \x01(\x05R\rcircularShift\x12\x16\n" +
	"\x06repeat\x18\x05 \x01(\rR\x06repeat\x12\x1b\n" +
	"\tover_void\x18\x06 \x01(\bR\boverVoid\x12=\n" +
	"\fdate_created\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampR\vdateCreated\"\x83\x01\n" +
	...
	"\x04Live\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponse\"\x00(\x010\x01B3Z,github.com/lesomnus/grpc-dgram/internal/echo\x92\x03\x02\b\x02b\beditionsp\xe8\a"
